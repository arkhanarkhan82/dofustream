...
// 1. CONFIGURATION  
// ==========================================
// GitHub credentials - now DYNAMIC, loaded from UI
let REPO_OWNER = '';
let REPO_NAME = '';
...
window.addEventListener("DOMContentLoaded", () => {
    ...
    // 3. Load GitHub credentials from localStorage
    ...
    // Auto-load config if credentials exist
    if (savedUsername && savedRepo && savedToken) {
        document.getElementById('ghStatus').innerText = `✅ Connected to ${savedRepo}`;
        document.getElementById('ghStatus').style.color = '#22c55e';
...
// ==========================================
// NEW: LIVE CMS FUNCTIONS
// ==========================================

async function triggerGhConnect() {
    ...
    try {
        ...
        if (result.status === 'success') {
            ...
            statusEl.innerText = `✅ Connected to ${repo}`;
